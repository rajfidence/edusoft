        ...
        .constant('VENDOR_ASSETS', {
            ...
            modules: [
              ...
              {name: 'datatables',                files: ['vendor/datatables/media/css/jquery.dataTables.min.css',
                                                          ...
                                                          'vendor/angular-datatables/dist/plugins/columnfilter/angular-datatables.columnfilter.min.js',
              ...
              {name: 'oitozero.ngSweetAlert',     files: ['vendor/sweetalert/dist/sweetalert.css',
                                                          ...
                                                          serie: true},
			  {name:'pdf',                        files: ['vendor/angularjs-pdf/example/js/lib/pdf.js',
                                                          'vendor/angularjs-pdf/dist/angular-pdf.js']},
              {name:'loading-overlay',            files: ['vendor/angular-spinner/spin.min.js',
                                                          'vendor/angular-spinner/angular-loading.min.js',
                                                          'vendor/angular-spinner/angular-loading.css']},
              {name:'ngMessages',                 files: ['vendor/angular-messages/angular-messages.min.js']},

              {name:'angular-intro',              files: ['vendor/angular-intro.js-master/src/intro.min.js',
                                                          'vendor/angular-intro.js-master/src/angular-intro.js',
                                                          'vendor/angular-intro.js-master/build/introjs.css'],
                                                  serie: true},

              {name:'ionicApp',                   files: ['vendor/shake/shake.css',
                                                          'vendor/shake/shake.js'],
                                                  serie: true},

              {name:'ngScrollable',                   files: ['vendor/ng-scrollable-master/min/ng-scrollable.min.css',
                                                          'vendor/ng-scrollable-master/src/ng-scrollable.js'],
                                                  serie: true},
              {name:'ngVideo',                   files: ['vendor/ngVideo-master/example/css/default.css',
                                                         'vendor/ngVideo-master/dist/ng-video.js'],
                                                         serie: true},
              {name:'angularMoment',                   files: ['vendor/angular-moment/moment-timezone.js',
