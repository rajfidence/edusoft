...
$config['auth_override_class_method']['users']['passwordRecovery'] = 'none';
$config['auth_override_class_method']['users']['passwordUpdate'] = 'none';
$config['auth_override_class_method']['users']['passKeyStatus'] = 'none';
$config['auth_override_class_method']['edusoftuser']['test'] = 'none';
$config['auth_override_class_method']['edusoftuser']['chatDemo'] = 'none';
/*
|--------------------------------------------------------------------------
