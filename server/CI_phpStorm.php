 ...
 * @property company_model $company_model         Company Model
 * @property billing_model $billing_model         Billing Model
 ...
 * @property CI_Utf8 $utf8                        Provides support for UTF-8 environments
 * @property CI_Security $security                Security Class, xss, csrf, etc...
 * @property CI_Phpmailer $phpmailer              Security Class, xss, csrf, etc...
 */
